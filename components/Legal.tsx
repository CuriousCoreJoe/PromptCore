...
Welcome to PromptOrigin. These Terms of Service ("Terms") govern your access to and use of the PromptOrigin website and services (the "Service"). By using the Service, you agree to be bound by these Terms.
 
 ## 1. Description of Service
 PromptOrigin provides an AI-powered platform for prompt engineering and batch generation of AI content.
...
PromptOrigin owns the Service, logo, and platform design. You own the prompts and content generated by your account while using the Service.
 
 ## 6. Limitation of Liability
 PromptOrigin is provided "as is" without warranty of any kind. We are not liable for any damages resulting from your use of the Service or any inaccuracies in AI-generated output.
...
At PromptOrigin, we respect your privacy. This Privacy Policy explains how we collect, use, and protect your information.
